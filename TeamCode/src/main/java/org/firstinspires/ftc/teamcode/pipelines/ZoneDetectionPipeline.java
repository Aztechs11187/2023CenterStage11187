...
public class ZoneDetectionPipeline implements VisionProcessor {
     ...
     */
    public ZoneDetectionPipeline(@NonNull Scalar lower, @NonNull Scalar upper, DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
