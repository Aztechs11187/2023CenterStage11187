...
import org.firstinspires.ftc.teamcode.pipelines.ZoneDetectionPipeline;
...
public class LeftVision extends OpMode {
    ...
    private ZoneDetectionPipeline colourMassDetectionProcessor;
    ...
    public void start() {
        ...
        ZoneDetectionPipeline.PropPositions recordedPropPosition = colourMassDetectionProcessor.getRecordedPropPosition();

        // now we can use recordedPropPosition to determine where the prop is! if we never saw a prop, your recorded position will be UNFOUND.
        // if it is UNFOUND, you can manually set it to any of the other positions to guess
        if (recordedPropPosition == ZoneDetectionPipeline.PropPositions.UNFOUND) {
            recordedPropPosition = ZoneDetectionPipeline.PropPositions.MIDDLE;
        }
